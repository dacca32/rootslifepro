            ...
            <div className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm'>
                <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
                    <div>
                        ...
                        <div className='mt-2'>
                            <input type="text" {...register('email')} placeholder='Enter email address...' className='block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-200 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-600 sm:text-sm/6' />
                        </div>
                    ...
                    <div>
                        <div className='flex items-center justify-between'>
                            ...
                            <div className='text-sm'>
                                <Link to='/login' className='fon-semibold text-indigo-600 hover:text-indigo-500'>
                ...
                <p className='mt-10 text-center text-sm/6 text-gray-300'>
                    Not got an account? <Link to='/login' className='font-semibold text-indigo-600 hover:text-indigo-500'>Sign up here</Link> </p>
            </div>
